class TicTacToe:
    ...
    def make_move(self, square, letter):
        #if valid move, then make the move (assign aquare to the letter)
    ...
    def winner(self, square, letter):
        #winner if 3 in a row anywhewre.. we have to check all of these!
